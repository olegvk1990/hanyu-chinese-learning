module.exports = [
  {
    title: { zh: '是...的 — 描述材料', pinyin: 'Shì...de — miáoshù cáiliào', ru: 'Конструкция 是...的 для описания материала', en: 'Using 是...的 to describe material' },
  ...
  {
    title: { zh: '用...做/造', pinyin: 'Yòng...zuò/zào', ru: 'Использование 用...做/造', en: 'Using 用...做/造' },
  ...
  {
    title: { zh: '材料量词', pinyin: 'Cáiliào liàngcí', ru: 'Счётные слова для материалов', en: 'Measure words for materials' },
  ...
  {
    title: { zh: '材料的比较', pinyin: 'Cáiliào de bǐjiào', ru: 'Сравнение материалов', en: 'Comparing materials' },
